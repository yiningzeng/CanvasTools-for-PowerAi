...
class Tag {
    ...
    get colorAccent() {
        if (this.tagColorAccent === "") {
            this.tagColorAccent = this.colorObj.sRGB.toCSSString(0.5);
        }
    ...
    get colorHighlight() {
        if (this.tagColorHighlight === "") {
            ...
            this.tagColorHighlight = highlight.toSRGB().truncate().toCSSString(0);
        }
    ...
    get colorShadow() {
        if (this.tagColorShadow === "") {
            ...
            this.tagColorShadow = shadow.toSRGB().truncate().toCSSString(0);
        }
    ...
    get colorDark() {
        if (this.tagColorDark === "") {
            ...
            this.tagColorDark = dark.toSRGB().truncate().toCSSString(0.5);
        }
